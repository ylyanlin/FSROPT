...
bool edge_type_is_cond_taken(arms_edge_type_t type);
bool edge_type_is_cond_not_taken(arms_edge_type_t type);
bool edge_type_is_direct_jmp(arms_edge_type_t type);
bool edge_type_is_indirect_jmp(arms_edge_type_t type);
...
public: 
	...
	//added by yanlin
	bool is_direct_jump(void) {return (type_== arms_direct_jmp);}
	//end
