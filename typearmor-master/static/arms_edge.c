...
bool
edge_type_is_cond_taken(arms_edge_type_t type)
{
	return (type == arms_cond_taken);
}

bool 
edge_type_is_cond_not_taken(arms_edge_type_t type)
{
	return (type == arms_cond_not_taken);
}
bool 
edge_type_is_direct_jmp(arms_edge_type_t type)
{
	return (type == arms_direct_jmp);
}

bool 
edge_type_is_indirect_jmp(arms_edge_type_t type)
{
	return (type == arms_indirect_jmp);
}
