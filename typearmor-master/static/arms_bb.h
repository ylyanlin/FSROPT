...
public:
	...
	void set_icall_width(std::vector<uint16_t> reg_width) {arg_width = reg_width;};
	std::vector<uint16_t> get_icall_width(void) { return arg_width;};
	#endif

	#ifdef STATISTICS
	void set_icall_pointer(std::vector<int> icallpointer) {icall_pointer = icallpointer;}
	std::vector<int> get_icall_pointer(void){return icall_pointer;}

	void set_icall_imm(std::vector<int> icallimm) {icall_imm = icallimm;}
	std::vector<int> get_icall_imm(void){return icall_imm;}

	void set_icall_wrapper(int icallwrapper) {icall_wrapper = icallwrapper;}
	int get_icall_wrapper(void){return icall_wrapper;}

	void set_icall_13(std::vector<int> icall13) {icall_13 = icall13;}
	std::vector<int> get_icall_13(void){return icall_13;}

	void set_icall_36(std::vector<int> icall36) {icall_36 = icall36;}
	std::vector<int> get_icall_36(void){return icall_36;}

	void set_icall_xor(std::vector<int> icallxor) {icall_xor = icallxor;}
	std::vector<int> get_icall_xor(void){return icall_xor;}

	void set_icall_bet(int icallbet) {icall_bet = icallbet;}

	int  is_icall_bet(void) { return icall_bet;}
	...
	bool outgoing_contains_call(void);
...
private: 
	...
	std::vector<int> icall_13;
	std::vector<int> icall_36;
	std::vector<int> icall_xor;
	int icall_wrapper;
	int icall_bet = 0;
	#endif 
